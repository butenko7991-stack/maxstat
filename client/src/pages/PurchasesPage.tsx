...
import { Plus, ShoppingCart, Pencil, Trash2, X, Check, ExternalLink } from "lucide-react";
...
export default function PurchasesPage() {
  ...
  const { data: records, isLoading } = trpc.purchases.list.useQuery({
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const payload = {
      ...
      targetChannels: form.targetChannels || undefined,
