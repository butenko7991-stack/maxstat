...
- [ ] Определить статусы и уровни уверенности: исправлено, уже верно, нужна проверка, нет данных, ошибка источника
- [ ] Автоматически применять только однозначно подтверждённые охваты за 24 часа
- [ ] Добавить причины отклонений и доступные действия для спорных записей
- [ ] Покрыть алгоритм тестами, собрать и развернуть на VPS
