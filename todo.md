...
- [ ] Зафиксировать владельца с неизменяемым полным доступом
- [ ] Добавить безопасную регистрацию пользователей и создание администраторов владельцем
- [ ] Реализовать независимые рабочие зоны: каждый админ видит и ведёт только свои каналы, учёт и аналитику
- [ ] Реализовать роли закупщика и менеджера только внутри команды конкретного администратора
- [ ] Создать интерфейс владельца и администраторов для регистрации пользователей и управления своими командами
- [ ] Покрыть регистрацию и разграничение доступа тестами, задеплоить на VPS
